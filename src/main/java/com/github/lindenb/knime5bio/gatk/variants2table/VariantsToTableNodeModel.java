package com.github.lindenb.knime5bio.gatk.variants2table;
import java.io.File;
...
public class VariantsToTableNodeModel extends AbstractVariantsToTableNodeModel {
@Override
    protected BufferedDataTable[] execute(final BufferedDataTable inTable, final ExecutionContext exec) throws Exception
		...
		try {
			...
			while(iter.hasNext()) {
				...
				final File outFile = super.createFileForWriting(Optional.of("VariantsToTable"), ".tsv");
