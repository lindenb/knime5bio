...
$(error expected count($$htsjdk.jar)=8 but got N='$(words ${htsjdk.jars})' for ${htsjdk.jars})
endif
...
$(eval $(call generatecode,com/github/lindenb/knime5bio/vcf/cutsamples/CutSamples,1,,,,,))
$(eval $(call generatecode,com/github/lindenb/knime5bio/vcf/renamechr/RenameContig,1,,,,,))
...
$(eval $(call generatecode,com/github/lindenb/knime5bio/util/table2file/TableToFile,1,,,,,))
...
$(eval $(call generatecode,com/github/lindenb/knime5bio/vcf/burdenfisherh/BurdenFisherH,1,,,,,))
$(eval $(call generatecode,com/github/lindenb/knime5bio/vcf/burdenfisherv/BurdenFisherV,1,,,,,))
...
$(eval $(call generatecode,com/github/lindenb/knime5bio/vcf/injectpedigree/InjectPedigree,1,,,,,))
...
${dist.dir}/com_github_lindenb_knime5bio.jar : $(sort ${knime.jars} ${extra.jars} ) \
	...
	${this.dir}src/main/java/com/github/lindenb/knime5bio/vcf/merge/MergeNodeModel.java \
	...
	${this.dir}src/main/java/com/github/lindenb/knime5bio/vcf/burdenfisherv/BurdenFisherVNodeModel.java \
	${this.dir}src/main/java/com/github/lindenb/knime5bio/vcf/burdenfisherh/BurdenFisherHNodeModel.java \
